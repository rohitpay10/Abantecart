...
class BPPGModule
{
    ...
    /**
     * [$pg_merchant_hosted_key description]
     * @var [type]
     */
    ...
    /**
     * @param string $pg_merchant_hosted_key
     *
     * @return self
     */
    public function setMarchantHostedKey($pg_merchant_hosted_key)
    {
...
public function handleResponse($ENCDATA)
    {
